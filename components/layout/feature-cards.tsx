...
import { Zap, Users, Calendar, BookOpen, Bell, TrendingUp } from "lucide-react";
import { Card, CardContent } from "@/components/ui/card";

const features = [
  { icon: Users, title: "Discover clubs", description: "Browse 35+ ESHS clubs and activities in one place." },
  ...
  { icon: BookOpen, title: "Attend workshops", description: "Find peer tutoring and student-led workshops." },
